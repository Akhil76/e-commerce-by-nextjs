    ...
    <main>
      <div className="m-2">
        <div className="bg-slate-400 py-2 flex justify-between ">
          <div>
            <h1 className="mx-2">Product List</h1>
          </div>
          <div>
            <button
        ...
        <table class="border-collapse border border-slate-500 w-full">
          <thead>
            <tr className="text-left bg-transparent">
              <th class="border border-slate-600 p-2 w-14">Product</th>
          ...
          <tbody>
            <tr>
              ...
              <td class="border border-slate-700">In stock</td>
              <td class="border border-slate-700">44$</td>
              <td class="border border-slate-700">
                <button
